...
# Usage: python chatglm2_openai_api.py
...
async def create_chat_completion(request: ChatCompletionRequest):
    ...
    response, _ = model.chat(tokenizer, query, history=history, generation_config=config)
...
async def predict(query: str, history: List[List[str]], model_id: str):
    ...
    for new_response in model.chat_stream(tokenizer, query, history, generation_config=config):
